//
//
// Based on `https://github.com/opencv/opencv/blob/master/modules/python/src2/cv2.cpp`
//  which is released under 3-clause BSD license.
//
//
#ifndef PYTHON_CV2_HPP_
#define PYTHON_CV2_HPP_
